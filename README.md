![小白龙](https://github.com/xiaoyuanda666-ship-it/XiaoBaiLong/blob/main/images/AGI128k.jpg)

# 小白龙

小白龙 是一个持续运行的桌面 AI Agent 项目。它不是一次问答结束就退出的聊天程序，而是由主循环驱动：有用户消息时优先处理，空闲时按节奏继续整理记忆、检查任务、刷新上下文，并把状态实时推送到 Brain UI。
...
小白龙 的长期状态主要保存在本地 SQLite 数据库中，包括：
