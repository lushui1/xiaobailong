      ...
      <div class="settings-content">
        ...
        <div class="settings-tab" data-tab="media">
          <div class="settings-section">
            <div class="settings-section-label">当前状态</div>
            <div class="settings-config-row">
              <span class="settings-config-type">图片生成</span>
          ...
          <div class="settings-section">
            <div class="settings-section-label">图片生成 Provider</div>
            <p class="settings-hint">选择图片生成服务商。MiniMax 内置，OpenAI DALL-E 需要单独配置 API Key。</p>
            <div class="settings-row">
              <label class="settings-label" for="media-image-provider">图片生成</label>
              <select class="settings-select" id="media-image-provider">
          ...
          <div class="settings-section" id="media-creds-minimax">
          ...
          <div class="settings-section" id="media-creds-openai" style="display:none;">
            <div class="settings-section-label">OpenAI DALL-E 配置</div>
            <div class="settings-row">
              <label class="settings-label" for="media-openai-key">OpenAI API Key</label>
              <input class="settings-input" id="media-openai-key" type="password" placeholder="填入 OpenAI API Key…" autocomplete="new-password">
            </div>
            <div class="settings-row">
              <label class="settings-label" for="media-openai-baseurl">Base URL（选填）</label>
              <input class="settings-input" id="media-openai-baseurl" type="text" placeholder="自定义端点，如 https://api.openai-proxy.com/v1">
            </div>
            <div class="settings-row">
              <label class="settings-label" for="media-openai-model">模型名（选填）</label>
              <input class="settings-input" id="media-openai-model" type="text" placeholder="默认 dall-e-3，可选 dall-e-2 或 gpt-image-1">
            </div>
            <p class="settings-hint">在 <a href="https://platform.openai.com/api-keys" target="_blank" style="color:var(--cool)">platform.openai.com</a> 获取 API Key。支持 DALL-E 3 / DALL-E 2 / gpt-image-1。</p>
          </div>

          <div class="settings-section" id="media-creds-custom" style="display:none;">
            <div class="settings-section-label">自定义图片生成配置</div>
            <div class="settings-row">
              <label class="settings-label" for="media-custom-url">Base URL</label>
              <input class="settings-input" id="media-custom-url" type="text" placeholder="如 https://api.siliconflow.cn 或 http://localhost:8080">
            </div>
            <div class="settings-row">
              <label class="settings-label" for="media-custom-key">API Key</label>
              <input class="settings-input" id="media-custom-key" type="password" placeholder="填入自定义图片生成服务的 API Key" autocomplete="new-password">
            </div>
            <div class="settings-row">
              <label class="settings-label" for="media-custom-model">模型名</label>
              <input class="settings-input" id="media-custom-model" type="text" placeholder="如 dall-e-3、flux、stable-diffusion 等">
            </div>
            <p class="settings-hint">支持任何兼容 OpenAI /v1/images/generations 接口的服务。</p>
          </div>

          <div class="settings-section settings-section-action">
            <button class="settings-save-btn" id="settings-save-media" type="button">保存媒体配置</button>
            <span class="settings-feedback" id="settings-media-feedback"></span>
          </div>
        </div>
          ...
          <div class="settings-section">
            ...
            <div class="settings-row">
              ...
              <select class="settings-select" id="voice-provider-select">
                ...
                <option value="custom">自定义（OpenAI Whisper 兼容）</option>
              </select>
            </div>
            ...
            <div id="voice-cred-custom" style="display:none;">
              <div class="settings-row">
                <label class="settings-label" for="voice-custom-url">Base URL</label>
                <input class="settings-input" type="text" id="voice-custom-url" placeholder="如 https://api.siliconflow.cn 或 http://localhost:8080">
              </div>
              <div class="settings-row">
                <label class="settings-label" for="voice-custom-key">API Key</label>
                <input class="settings-input" type="password" id="voice-custom-key" placeholder="填入自定义 ASR 服务的 API Key">
              </div>
              <div class="settings-row">
                <label class="settings-label" for="voice-custom-model">模型名称</label>
                <input class="settings-input" type="text" id="voice-custom-model" placeholder="如 whisper-1，留空默认 whisper-1">
              </div>
            </div>
          </div>

          <div class="settings-section" id="settings-tts-section">
            <div class="settings-section-label">语音合成（TTS）- 自定义 Provider</div>
            <p class="settings-hint">用语音发消息时，Agent 回复会自动转为语音播放。支持豆包、MiniMax、OpenAI、ElevenLabs、火山引擎，每个都可配置独立 API Key。</p>
            <div class="settings-row">
            ...
            <div class="settings-row">
              <label class="settings-label" for="tts-provider-select">TTS 服务商</label>
            ...
            <div id="tts-creds-doubao" style="display:none;">
              <div class="settings-row">
                <label class="settings-label" for="tts-doubao-key">豆包 API Key</label>
              ...
              <div class="settings-row">
                ...
                <input class="settings-input" type="password" id="tts-doubao-access-key" placeholder="旧版控制台 Access Token">
              </div>
            </div>
            ...
            <div id="tts-creds-volcano" style="display:none;">
              <div class="settings-row">
                <label class="settings-label" for="tts-volcano-appid">火山引擎 AppId</label>
            ...
            <div id="tts-creds-custom" style="display:none;">
              <div class="settings-row">
                <label class="settings-label" for="tts-custom-url">Base URL</label>
                <input class="settings-input" type="text" id="tts-custom-url" placeholder="如 https://api.siliconflow.cn 或 http://localhost:8080">
              </div>
              <div class="settings-row">
                <label class="settings-label" for="tts-custom-key">API Key</label>
                <input class="settings-input" type="password" id="tts-custom-key" placeholder="填入自定义 TTS 服务的 API Key">
              </div>
              <div class="settings-row">
                <label class="settings-label" for="tts-custom-model">模型名称</label>
                <input class="settings-input" type="text" id="tts-custom-model" placeholder="如 tts-1、CosyVoice 等，留空默认 tts-1">
              </div>
            </div>
